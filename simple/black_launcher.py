#!/usr/bin/env python3
"""
Stable Black GUI Launcher
Uses regular tkinter for maximum compatibility
"""
...
def main():
    print("🚀 Starting LETO VISION with Black GUI...")
    ...
    if missing:
        ...
        print("\n✨ App will start anyway - you can select files manually!")
    
    try:
        from black_tkinter_gui import main as gui_main
        gui_main()
        return 0
